...
var file_proto_worker_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x22, 0x2b, 0x0a, 0x05,
	0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x6d, 0x33, 0x75, 0x38, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x6d, 0x33, 0x75, 0x38, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x74, 0x73, 0x22, 0x1e, 0x0a, 0x06, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x72, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x05, 0x66, 0x72, 0x61, 0x6d, 0x65, 0x22, 0x24, 0x0a, 0x06, 0x53, 0x6f, 0x75,
	...
	,
...
var file_proto_worker_proto_goTypes = []interface{}{
	(*Video)(nil),  // 0: worker.Video
	(*Result)(nil), // 1: worker.Result
	(*Source)(nil), // 2: worker.Source
	(*Worker)(nil), // 3: worker.Worker
	(*Status)(nil), // 4: worker.Status
}
var file_proto_worker_proto_depIdxs = []int32{
	3, // 0: worker.Worker_gRPC.GetStatus:input_type -> worker.Worker
	2, // 1: worker.Worker_gRPC.GetVideo:input_type -> worker.Source
	2, // 2: worker.Worker_gRPC.RestreamVideo:input_type -> worker.Source
	4, // 3: worker.Worker_gRPC.GetStatus:output_type -> worker.Status
	1, // 4: worker.Worker_gRPC.GetVideo:output_type -> worker.Result
	2, // 5: worker.Worker_gRPC.RestreamVideo:output_type -> worker.Source
